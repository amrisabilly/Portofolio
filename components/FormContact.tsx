...
const FormContact = () => {
  return (
    <div className="w-full bg-gradient-to-r from-transparent via-[#525151]/10 to-[#525151]/20  py-5 sm:pt-5 md:pt-8 mb-[1em] md:mb-[3em] lg:mb-[3em]">
      <form
        action="https://formsubmit.co/amrsabill@gmail.com" // Ganti dengan email Anda
        method="POST"

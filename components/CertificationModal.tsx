...
const CertificationModal = ({
  ...
  return (
    <motion.div
      className="fixed inset-0 backdrop-blur-md flex items-center justify-center p-2 md:p-4"
      style={{
        backgroundColor: "#14181AE6",
        zIndex: 9999, // Increase z-index to ensure it's above carousel
      }}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
        ...
        <div className="flex justify-between items-start mb-4 md:mb-6">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(0, 168, 205, 0.1), rgba(0, 168, 205, 0.05))",
              }}
            />
